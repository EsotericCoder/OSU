...
int main() {
	...
	while (!file.eof()) {
		...
		printAlgorithmData(outFile, algorithm1, arr, nComma + 1);
		printAlgorithmData(outFile, algorithm2, arr, nComma + 1);
		printAlgorithmData(outFile, algorithm3, arr, nComma + 1);
		printAlgorithmData(outFile, algorithm4, arr, nComma + 1);
		outFile << endl;
